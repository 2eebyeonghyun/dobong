...
if(!$list_url) $list_url = "association_schedule4.php";
...
*/
						...
						// 지점, 날짜 확인
						$query02 = "select s_cd, req_sdate from ddm_daynursery where idx = ".$idx;
...
//		$appValue = "1";
	...
	if($ddm_result[s_cd]=="04" && (int)$attendance_result[regdate] + 86400*7 > $today_timestamp)
	{
		$appValue  = "6";
...
<!--
				<div class="__tab3">
					<a href="<?=DIR?>/care/association.php"><span>답십리점 공동육아방 이용신청</span></a>
					<a href="<?=DIR?>/care/association.php"><span>제기점 공동육아방 이용신청</span></a>
					<a href="<?=DIR?>/care/association.php"><span>배봉산점 공동육아방 이용신청</span></a>
					<a href="<?=DIR?>/care/association.php" class="active"><span>장안2동점 공동육아방 이용신청</span></a>
					<a href="<?=DIR?>/care/association.php"><span>제기2호점 공동육아방 이용신청</span></a>
					<a href="javascript:alert('이용 준비중입니다.');"><span>장안1동점 공동육아방(준비중)</span></a>
				</div>
-->
                <div class="__tab3">
					<a href="<?=DIR?>/care/association.php"><span>답십리점 공동육아방</span></a>
					<a href="<?=DIR?>/care/association.php"><span>답십리2호점 공동육아방</span></a>
					<a href="<?=DIR?>/care/association.php"><span>제기점 공동육아방</span></a>
					<a href="<?=DIR?>/care/association.php"><span>배봉산점 공동육아방</span></a>
					<a href="#" class="active"><span>장안2동점 공동육아방</span></a>
					<a href="<?=DIR?>/care/association.php"><span>제기2호점 공동육아방</span></a>
					<a href="<?=DIR?>/care/association.php"><span>장안1동점 공동육아방</span></a>
					<a href="<?=DIR?>/care/association.php"><span>용신점 공동육아방</span></a>
				</div>
					...
					<tr id="idDisType202" >
						...
						<td>
							<select name="child_count" onchange='<?
												...
												<?
												$limit = 5;
												if($_SESSION['member_level']=='기관' || $job1 =='보육시설종사자') $limit = 25;
												for($i = 0; $i <= $limit; $i++)
												{
