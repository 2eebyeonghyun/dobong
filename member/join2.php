...
<div id="wrap" class="wrap">
    ...
    <section class="section member-page join-page join_2-page">
            ...
            <div class="inner">
                <div id="content">
                    <div class="__joinProcess">
                        ...
                        <div class="step step2 active"><span>02.회원정보 입력</span></div>
                        <div class="step step3"><span>03.가입완료</span></div>
                    </div>

                    <form name="frm" method="post" action="<?=$INFO['url_ssl'].$tmpproc?>" onsubmit="return input_check(this);" autocomplete="off">
                        ...
                        <table class="__tblView respond">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <? if( $row['userid'] || $_SESSION['masterSession']=="master"){ ?>
                                            ...
                                            <?=$row[userid]?>
                                        <? }else{ ?>
                                            <input type="text" class="__inp __m-w50p" style="width:270px;" name="userid" maxlength="12" style="IME-MODE:disabled;" autocomplete="off"> &nbsp;<button type="button" class="__btn2 vat" onclick="popId2();">중복확인</button>
                                        <? } ?>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="password" class="__inp __m-w100p" style="width:270px;" name="passwd" maxlength="20" autocomplete="new-password">
                                ...
                                <tr>
                                    ...
                                    <td>
                                      <?=!$_SESSION['member_id']?$name:$row[name]?>
                                    </td>
                                </tr>
                                ...
                                <tr class="pay_m">
                                    ...
                                    <td>
                                        <label><input type="radio" id="toyEntry1Y" value="Y" name="toyEntry1" onclick="toyEntryChange1('<?=$modeValue?>');"> 가입</label>
                                        <label><input type="radio" id="toyEntry1N" value="N" name="toyEntry1" checked <? if($row['toyEntry'] == "N"){ echo "checked"; } ?> onclick="toyEntryChange1('<?=$modeValue?>');"> 가입하지 않음</label>
                        ...
                        <script language="javascript">
                            function job1Choice(v1){
                                switch(v1){
                                  case "부모":
                                    document.getElementById("idJob2").style.display = "none";
                                    document.getElementById("idJobEteMsg").style.display = "none";
                                    document.getElementById("idSisulInfo").style.display = "none";
                                    break;
                                  case "보육시설종사자":
                                    document.getElementById("idJob2").style.display = "";
                                    document.getElementById("idJobEteMsg").style.display = "none";	
                                    document.getElementById("idSisulInfo").style.display = "";
                                    break;
                                  case "기타":
                                    document.getElementById("idJob2").style.display = "none";
                                    document.getElementById("idJobEteMsg").style.display = "";	
                                    document.getElementById("idSisulInfo").style.display = "none";
                                    break;
                                }
                            }
                        ...
                        <!-- 개인 -->
                        <div class="private_m" style="display: none;">
                            <div class="__tit1 __mt50">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <label><input type="radio" value="seoul" name="member_chk" <? if($row['member_chk'] == "seoul"){ echo "checked"; } ?>> 서울시민</label>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <label><input type="radio" value="changdong" name="center_chk" <? if($row['center_chk'] == "changdong"){ echo "checked"; } ?>> 창동센터</label>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="m_grid_wr">
                                            ...
                                            <label><input type="radio" value="redu_2" name="redu_chk" <? if($row['center_chk'] == "redu_2"){ echo "checked"; } ?>> 수급권자 및 차상위계층</label>
                                            <label><input type="radio" value="redu_3" name="redu_chk" <? if($row['center_chk'] == "redu_3"){ echo "checked"; } ?>> 국가유공자</label>
                                            <label><input type="radio" value="redu_4" name="redu_chk" <? if($row['center_chk'] == "redu_4"){ echo "checked"; } ?>> 장애인세대</label>
                                            <label><input type="radio" value="redu_5" name="redu_chk" <? if($row['center_chk'] == "redu_5"){ echo "checked"; } ?>> 다둥이카드소지자</label>
                                            <label><input type="radio" value="redu_6" name="redu_chk" <? if($row['center_chk'] == "redu_6"){ echo "checked"; } ?>> 한부모가족지원법에 따른 지원대상자</label>
                                            <label><input type="radio" value="redu_7" name="redu_chk" <? if($row['center_chk'] == "redu_7"){ echo "checked"; } ?>> 기타 구청장이 인정하는 자</label>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table class="__tblView respond" id="member_style2" style="display:<?=$style2?>;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="memtype5" class="__inp">
                                                <option value="">선택하세요</option>
                                                <option value="원장" <?if($row[memtype5] == "원장"){ echo"selected"; }?>>원장</option>
                                                <option value="보유교사" <?if($row[memtype5] == "보유교사"){ echo"selected"; }?>>보유교사</option>
                                                <option value="특수교사(치료사)" <?if($row[memtype5] == "특수교사(치료사)"){ echo"selected"; }?>>특수교사(치료사)</option>
                                                <option value="간호사(간호조무사)" <?if($row[memtype5] == "간호사(간호조무사)"){ echo"selected"; }?>>간호사(간호조무사)</option>
                                                <option value="영양사" <?if($row[memtype5] == "영양사"){ echo"selected"; }?>>영양사</option>
                                                <option value="조리원" <?if($row[memtype5] == "조리원"){ echo"selected"; }?>>조리원</option>
                                                <option value="기타 보육교직원" <?if($row[memtype5] == "기타 보육교직원"){ echo"selected"; }?>>기타 보육교직원</option>
                                            </select>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="flexbox">
                                            <input name="cpName" type="text" class="__inp company_search_textbox" value="">
                                        </td>
                                    </tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="tal">
                                <dl class="__popDl">
                                    <dt>[회원자격]</dt>
                                    <dd>만 5세 이하의 영유아 자녀를 둔 서울시민, 예비부모 동대문구 소재 어린이집 보육교직원</dd>
                                </dl>
                        ...
                        <tr>
                            ...
                            <td class="tal">
                                <dl class="__popDl">
                                    <dt>[개인회원]</dt>
                                    <dd>
                                        1회 장난감 2점, 도서 3권 대여, 7일 대여(7일 연장 가능)
                                        장난감을 대여하지 않을경우 도서 5권 대여 
                                    </dd>
                                </dl>
                                ...
                                <dl class="__popDl">
                                    <dt>[기관회원]</dt>
                                    <dd>
                                        1회 장난감 5점, 도서 5권 대여, 7일 대여(7일 연장 가능)
                                        장난감을 대여하지 않을경우 도서 10권 대여 
                                    </dd>
                                </dl>
