...
<?
$_dep = array(3,1,2);
$_tit = array('양육지원','장난감대여사업','답십리점 장난감검색');
...
<?
	...
	// 	$url_chk = "http://".$_SERVER['HTTP_HOST'].$_SERVER['PHP_SELF'];
	// } else{
	// 	$url_chk = "https://".$_SERVER['HTTP_HOST'].":".$_SERVER['SERVER_PORT'].$_SERVER['PHP_SELF'];;
	// }

	// $url_chk02 = explode("?",$_SERVER['HTTP_REFERER']);

	// if($url_chk!=$url_chk02[0]){
?>
<!-- <script>
	alert("** 장난감 예약을 원하실 경우 \n'대여가능' 장난감을 선택하세요.");
</script> -->
<?
	//}
?>
