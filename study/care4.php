          ...
          <div class="inner">
              <div id="content">
                  <div class="__tab3">
                      ...
                      <a href="<?=DIR?>/study/care3.php" class=""><span>대체인력추가신청</span></a>
                      <a href="<?=DIR?>/study/care4.php" class="active"><span>보육교직원상담</span></a>
                  </div>

                  <div class="tac __mb30">
                      <div class="__scheHead">
                          <strong>2020년 8월</strong>
                          ...
                          <tbody>
                              ...
                              <tr>
                                  <td class="sun">
                                      ...
                                      <div class="cont tal">
                                          <a href="<?=DIR?>/study/care4_frm.php" class="flt">
                  ...
                  <table class="__tblList respond2">
                      ...
                      <tbody>
                          <tr>
                              ...
                              <td class="subject">
                                  <a href="<?=DIR?>/study/care4_frm.php">[배봉산점] 꿈자람 공동육아방 - 1회차(10:00~11:30)</a>
                              </td>
                              <td>320 / 120</td>
