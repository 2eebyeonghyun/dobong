...
// 	$listQuery		= "SELECT *
// 							FROM ona_htable_app
// 							WHERE userid='".$_SESSION['member_id']."' && delete_yn='N' && s_cd='03' ORDER BY idx DESC";
            ...
            <div class="inner">
                <div id="content">
                    ...
                    <div class="__tab2">
                        ...
                        <a href="<?=DIR?>/mypage/table2.php"><span>창동센터 상차림신청</span></a>
                        <a href="<?=DIR?>/mypage/table3.php" class="active"><span>휘경점 상차림신청</span></a>
                    </div>
