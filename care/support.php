<?
$pno = "020101";
$view_url = "support_view.php";
?>
<?
$_dep = array(2,6,1);
$_tit = array('보육지원','보육행정 및 어린이집 지원','보육사업 안내');
...
<div id="wrap" class="sub sub<?=$_dep[0];?> sub<?=$_dep[0].$_dep[1];?>">
	...
	<div id="sub">
		<div class="inner">
			<div id="tit_tab">
				<h2><img src="../images/icon/support.gif">보육행정 및 어린이집 지원</h2>
			</div>
			<div id="content">

				<div class="__tab3">
					<a href="<?=DIR?>/care/support.php" class="active"><span>보육사업 안내</span></a>
					<a href="<?=DIR?>/care/support2.php"><span>관계법령</span></a>
				</div>
