...
$pno = $_REQUEST['pno'];
if(!$pno) $pno = "040101";
if(!$list_url) $list_url = "notice02.php";

if($pno=="040101"){
	$list_url = "notice02.php";
	$_dep = array(5,1);
...
<iframe src="https://www.ddmccic.or.kr/upload/board/2021_ChildcareGuide.pdf" style="width:700px; height:700px;" frameborder="0"></iframe>
