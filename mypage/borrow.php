...
// 		mysql_query("delete from ddm_usecenter_app where idx = '".$_POST[idx]."'");
// 		echo "<script language='javascript'>
// 					 location.href('/html/sub/index.php?pno=".$pno."&page=".$page."&state=".$state."');
// 				  </script>";
// 	}

// 	$listQuery		= "SELECT * FROM ddm_usecenter_app WHERE userid='".$_SESSION['member_id']."' ORDER BY idx DESC";
...
<div id="wrap" class="wrap">
    ...
    <section class="section member-page borrow-page">
        ...
        <article class="cont cont1">
            <div class="inner">
                <div id="content">
                    ...
                    <div class="__tab2">
                        <a href="<?=DIR?>/mypage/borrow.php" class="active"><span>방학센터 대관신청</span></a>
                        <a href="<?=DIR?>/mypage/borrow2.php"><span>창동센터 대관신청</span></a>
                    </div>
