			...
			<div id="content">
				...
				<div class="__boardView type2">
					...
					<div class="__rendInfo">
						...
						<dl>
							<dt>신청현황</dt>
							<dd>가능인원<?if($rs[gubun]=='우리아이 쑥쑥' || $rs[gubun]=='영유아프로그램'){echo '(아동)';}?> <strong><?=number_format($inwon_empty)?></strong>명 / 신청인원<?if($rs[gubun]=='우리아이 쑥쑥' || $rs[gubun]=='영유아프로그램'){echo '(아동)';}?>
										  <? if($app_type) echo number_format($all_child_count); else echo number_format($appInwon); ?>명</dd>
						</dl>
						<dl>
							<dt>대기신청현황</dt>
							<dd>가능인원<?if($rs[gubun]=='우리아이 쑥쑥' || $rs[gubun]=='영유아프로그램'){echo '(아동)';}?> <strong><?=number_format($winwon_empty)?></strong>명 / 신청인원<?if($rs[gubun]=='우리아이 쑥쑥' || $rs[gubun]=='영유아프로그램'){echo '(아동)';}?>
