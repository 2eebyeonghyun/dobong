	...
	<div id="sub">
		<div class="inner">
			...
			<div id="content">
				...
				<div class="__tab3">
					<a href="javascript:alert('이용 준비중입니다.');" class="active"><span>답십리점(준비중)</span></a>
					<a href="javascript:alert('이용 준비중입니다.');"><span>제기점(준비중)</span></a>
					<a href="<?=DIR?>/care/association.php"><span>배봉산점 </span></a>
					<a href="<?=DIR?>/care/association.php"><span>장안2동점 </span></a>
					<a href="javascript:alert('이용 준비중입니다.');"><span>제기2호점 (준비중)</span></a>
...
<div class="__popBasic popApp">
	...
	<form name="frm" method="post" action="020207_proc3.php" onSubmit="return appCheck(this);" >
