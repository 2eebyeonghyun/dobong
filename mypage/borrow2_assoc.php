...
<?
	...
	$listQuery		= "SELECT * FROM ddm_usecenter_app3 WHERE userid='".$_SESSION['member_id']."' and scd ='02' ORDER BY idx DESC";
	...
	<div id="sub">
		<div class="inner">
			...
			<div id="content">
				...
				<div class="__tab2">
					<a href="./borrow_assoc.php"><span>답십리 대관신청</span></a>
					<a href="./borrow2_assoc.php" class="active"><span>제기점 대관신청</span></a>
				</div>
