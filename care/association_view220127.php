...
if(!$list_url) $list_url = "association_schedule.php";
...
//		$query	= "select * from ddm_daynursery_absence where mbId = 'wjdals0622' order by regdate desc limit 1";
//		$appValue = "1";
//		echo (int)$attendance_result[regdate] + 86400*7;
//		echo ( (int)$attendance_result[regdate] + 86400*7 - $today_timestamp ) / 86400;
//		echo $query;
	}
	...
	if($ddm_result[s_cd]=="01" && (int)$attendance_result[regdate] + 86400*7 > $today_timestamp)
	{
		$appValue  = "6";
...
<div id="wrap" class="sub sub<?=$_dep[0];?> sub<?=$_dep[0].$_dep[1];?>">
	...
	<div id="sub">
		<div class="inner">
			<div id="tit_tab">
				<h2>꿈자람공동육아방 온라인 신청하기</h2>
			</div>
			<div id="content">

				<div class="__tab3">
					<a href="<?=DIR?>/care/association.php" class="active"><span>답십리점</span></a>
					<a href="<?=DIR?>/care/association.php"><span>제기점</span></a>
					<a href="<?=DIR?>/care/association.php"><span>배봉산점</span></a>
					<a href="<?=DIR?>/care/association.php"><span>장안2동점</span></a>
					<a href="<?=DIR?>/care/association.php"><span>제기2호점</span></a>
					<a href="javascript:alert('이용 준비중입니다.');"><span>장안1동점(준비중)</span></a>
				</div>
...
//교육 신청할 때 추가인원 나오기전에 "추가할 인원이 있으신가요? "예, 아니오" 하고 "예"라고 체크하면, "교육 신청자도 교육에 함께 참석하실건가요? "예, 아니요" 물어본후  "예" 라고 하면 추가 인원과 추가 상세내용(직급칸은 없애주세요. 시설명과 시설유형,연락처를 필수로 해주세요)이 나오도록해 주시고, 
 //"아니오"라고 하면 추가인원신청 칸이 안 나오게 해주세요.
	...
	{	
		...
		var head_form		= "<div id='head_form'><span style='margin-left:4px;'>이름(영유아/동반자)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style='margin-left:12px;'>생년월일</span></div>";
