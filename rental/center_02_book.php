<? 
$_dep = array(4,3,2);
$_tit = array('도서·장난감 검색','창동센터','도서검색');
        ...
        <article class="cont cont1">
            <div class="inner">
                <div id="content">
                    <div class="row">
                        <div class="__tab3">
                            <a href="<?=DIR?>/rental/center_02_toy.php" class=""><span>장난감검색</span></a>
                            <a href="<?=DIR?>/rental/center_02_book.php" class="active"><span>도서검색</span></a>
                        </div>
