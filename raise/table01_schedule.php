...
<?
$_dep = array(3,7,1);
$_tit = array('양육지원','상차림대여사업','답십리점 신청하기');
...
<? if(true){ ?>
		if(confirm('예약신청 하시겠습니까?')){
			location.href='03010109_proc.php?pno=03010109&mode=proc&barcode='+barcode+'&sdate='+sdate+'&type=app';
			return true;
		}
<? } else{ ?>
...
<div class="__tab3">
					<a href="<?=DIR?>/raise/table01.html" class="active"><span>답십리점 상차림 신청</span></a>
					<a href="<?=DIR?>/raise/table02.html"><span>제기점 상차림  신청</span></a>
...
if($dayClass == 'normal' && trim($mSCH['day']) != "" && trim($row['ho_name'])=="") {
						$itemInfo = array(array('우드상차림', 'DM01TG00001901'), array('전통상차림', 'DM01TG00001801'), array('전통상차림2', 'DM01TG00002101'), array('모던상차림', 'DM01TG00002001'));
