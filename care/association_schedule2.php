...
<?
$_dep = array(2,8,3);
$_tit = array('보육지원','꿈자람공동육아방','제기점 신청');
...
//				echo "<br />";
			...
			$tmpEdu = " <A href=association_view2.php?pno=".$pno."&mode=view&idx=".$mSCH['idx'][$i]."&toYear=".$mYear."&toMonth=".$mMonth."&sitem=".$sitem."&skey=".$skey."&page=".$mPage." class='flt'>";
			...
			$today_ = date("Ymd H");
			// if($today_ > "20210810 09"){
			// 	if($chkDate <= "20210810") $mEdu['1'] = "";
			// } else{
			// 	if($chkDate <= "20211232") $mEdu['1'] = "";
			// }
			if($chkDate > "20230528"){
...
// 			if($day_w == 4){
// 				$query .= "('꿈자람공동육아방', '[제기점]꿈자람 공동육아방-1회차(10:00~12:00)', '".strtotime($day_res_01_s)."', '".strtotime($day_res_01_e)."', '".strtotime($day_app_01_s)."', '".strtotime($day_app_01_e)."', '10:00~12:00', '동대문구육아종합지원센터 제기점 2층 공동육아방', 25, 0, '', '<div><strong>이용대상</strong></div><div><strong>&nbsp; 만5세이하의 영유아 및 보호자</strong></div><div><strong><br></strong></div><div><strong>이용시간</strong></div><div><strong>&nbsp;&nbsp;[개인회원] 화요일 ~ 토요일 : 10:00~17:30</strong></div><div><strong>&nbsp;&nbsp;1회차: 10:00~12:00</strong></div><div><strong>&nbsp;&nbsp;2회차: 13:00~15:00</strong><div><strong>&nbsp; 3회차: 15:30~17:30</strong></div><div><strong>&nbsp; [기관회원]: 목요일 10:00~12:00</strong></div></div><div><div><strong><br></strong></div><div><strong><span style=\'letter-spacing: 0pt; font-family: 맑은 고딕; font-size: 9pt; mso-fareast-font-family: 맑은 고딕; mso-font-width: 100%; mso-text-raise: 0pt; mso-hansi-font-family: 맑은 고딕;\'>※</span> 환경정비시간 : 12:00~13:00, 15:00~15:30, 17:30~18:00 (이용불가)</strong></div></div><div><strong>&nbsp; 휴관일 : 월요일 / 일요일 / 공휴일</strong></div>
...
// 			}
// 			$query .= ",('꿈자람공동육아방', '[제기점]꿈자람 공동육아방-2회차(13:00~15:00)', '".strtotime($day_res_02_s)."', '".strtotime($day_res_02_e)."', '".strtotime($day_app_02_s)."', '".strtotime($day_app_02_e)."', '13:00~15:00', '동대문구육아종합지원센터 제기점 2층 공동육아방', 25, 0, '', '<div><strong>이용대상</strong></div><div><strong>&nbsp; 만5세이하의 영유아 및 보호자</strong></div><div><strong><br></strong></div><div><strong>이용시간</strong></div><div><strong>&nbsp;&nbsp;[개인회원] 화요일 ~ 토요일 : 10:00~17:30</strong></div><div><strong>&nbsp;&nbsp;1회차: 10:00~12:00</strong></div><div><strong>&nbsp;&nbsp;2회차: 13:00~15:00</strong><div><strong>&nbsp; 3회차: 15:30~17:30</strong></div><div><strong>&nbsp; [기관회원]: 목요일 10:00~12:00</strong></div></div><div><div><strong><br></strong></div><div><strong><span style=\'letter-spacing: 0pt; font-family: 맑은 고딕; font-size: 9pt; mso-fareast-font-family: 맑은 고딕; mso-font-width: 100%; mso-text-raise: 0pt; mso-hansi-font-family: 맑은 고딕;\'>※</span> 환경정비시간 : 12:00~13:00, 15:00~15:30, 17:30~18:00 (이용불가)</strong></div></div><div><strong>&nbsp; 휴관일 : 월요일 / 일요일 / 공휴일</strong></div>
// 			<p class=\'0\' style=\'mso-pagination: none; mso-padding-alt: 0pt 0pt 0pt 0pt;\'><span style=\'font-family: 굴림;color:red;font-weight:bold;\'>※ 초등학생 동반  시 입장 불가<br>※ 별도의 주차공간이 없으므로, 대중교통 이용바람 <br>※ 공동육아방 예약 시작시간 이후 취소 및 당일 불참 시 해당지점 한 주간 이용 및 예약불가(타지점은 예약 가능)</span></p>', '접수', '', '', '', '', '', 0, 'N', '', '".$s_cd."', '', '', 'N')";

// 			$query .= ",('꿈자람공동육아방', '[제기점]꿈자람 공동육아방-3회차(15:30~17:30)', '".strtotime($day_res_03_s)."', '".strtotime($day_res_03_e)."', '".strtotime($day_app_03_s)."', '".strtotime($day_app_03_e)."', '15:30~17:30', '동대문구육아종합지원센터 제기점 2층 공동육아방', 25, 0, '', '<div><strong>이용대상</strong></div><div><strong>&nbsp; 만5세이하의 영유아 및 보호자</strong></div><div><strong><br></strong></div><div><strong>이용시간</strong></div><div><strong>&nbsp;&nbsp;[개인회원] 화요일 ~ 토요일 : 10:00~17:30</strong></div><div><strong>&nbsp;&nbsp;1회차: 10:00~12:00</strong></div><div><strong>&nbsp;&nbsp;2회차: 13:00~15:00</strong><div><strong>&nbsp; 3회차: 15:30~17:30</strong></div><div><strong>&nbsp; [기관회원]: 목요일 10:00~12:00</strong></div></div><div><div><strong><br></strong></div><div><strong><span style=\'letter-spacing: 0pt; font-family: 맑은 고딕; font-size: 9pt; mso-fareast-font-family: 맑은 고딕; mso-font-width: 100%; mso-text-raise: 0pt; mso-hansi-font-family: 맑은 고딕;\'>※</span> 환경정비시간 : 12:00~13:00, 15:00~15:30, 17:30~18:00 (이용불가)</strong></div></div><div><strong>&nbsp; 휴관일 : 월요일 / 일요일 / 공휴일</strong></div>
// 			<p class=\'0\' style=\'mso-pagination: none; mso-padding-alt: 0pt 0pt 0pt 0pt;\'><span style=\'font-family: 굴림;color:red;font-weight:bold;\'>※ 초등학생 동반  시 입장 불가<br>※ 별도의 주차공간이 없으므로, 대중교통 이용바람 <br>※ 공동육아방 예약 시작시간 이후 취소 및 당일 불참 시 해당지점 한 주간 이용 및 예약불가(타지점은 예약 가능)</span></p>', '접수', '', '', '', '', '', 0, 'N', '', '".$s_cd."', '', '', 'N');";
