...
<div id="wrap" class="wrap">
    ...
    <section class="section member-page book-page">
            ...
            <div class="inner">
                <div id="content">
                    ...
                    <div class="__tab">
                        ...
                        <a href="<?=DIR?>/mypage/book.php" class="active"><span>도서 대여</span></a>
                  ...
                  //										$state .= "&nbsp;<FONT color=\"blue\" onClick=\"OrderExt(".$row['orderno'].")\" style=\"cursor:hand\">연장하기</FONT>";
                                      $state .= '&nbsp;<span class="__ico1 blue" onClick="OrderExt('.$row['orderno'].')">연장하기</span>';
                                    }else{
