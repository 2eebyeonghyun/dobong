...
$pno = $_REQUEST['pno'];
if(!$pno) $pno = "02030303";
if(!$list_url) $list_url = "appraisal3_2.php";
?>
<?
$_dep = array(2,1,3);
	...
	<div id="sub">
		<div class="inner">
			...
			<div id="content">
				...
				<div class="__tab3">
					<a href="<?=DIR?>/care/appraisal.html"><span>평가제 안내</span></a>
					<a href="<?=DIR?>/care/appraisal2.html"><span>평가제 운영체계</span></a>
					<a href="<?=DIR?>/care/appraisal3.html" class="active"><span>관련자료실</span></a>
					<a href="<?=DIR?>/care/appraisal4.html"><span>컨설팅 사업</span></a>
				</div>

				<div class="__tab">
					<a href="appraisal3.php"><span>평가 메뉴얼 안내서</span></a>
					<a href="appraisal3_2.php" class="active"><span>인증문서 서식</span></a>
				</div>
