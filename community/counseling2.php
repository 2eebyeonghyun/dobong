...
<div id="wrap" class="wrap">
    ...
    <section class="section notice-page counseling-page counseling02-page">
            ...
            <div class="inner">
                <div id="content">
                    <div class="__tab3">
                        ...
                        <a href="<?=DIR?>/community/counseling2.php" class="active"><span>보육교직원상담</span></a>
                    ...
                    <div class="row">
                        ...
                        <div class="bot">
                            ...
                            <div class="write_btn_wr">
                                <a href="<?=DIR?>/community/counseling_write2.php" class="write_btn">글쓰기</a>
                            </div>
