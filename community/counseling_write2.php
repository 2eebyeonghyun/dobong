...
<div id="wrap" class="wrap">
    ...
    <section class="section care-page notice-page sub08-page frm-page">
                        ...
                        <div class="frm_wr">
                            <form action="?" method="post" name="counseling_frm" id="counseling_frm" class="counselingFrm" onsubmit="return submitbtn();">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="w100" colspan="4">
                                                <div class="radio_area">
                                                    ...
                                                    <ul class="radio_wr">
                                                        <li><input type="radio" name="counseling_chk1" id="counseling_chk1" class="counselingChk counselingChk1"><label for="counseling_chk1">있음</label></li>
                                                        <li><input type="radio" name="counseling_chk1" id="counseling_chk2" class="counselingChk counselingChk2"><label for="counseling_chk2">없음</label></li>
                                                    </ul>
                                                </div>
                                            </td>
                                            <td class="w100 border-bottom" colspan="4">
                                                <div class="radio_area">
                                                    ...
                                                    <ul class="radio_wr">
                                                        <li><input type="radio" name="counseling_chk2" id="counseling_chk3" class="counselingChk counselingChk3"><label for="counseling_chk3">있음</label></li>
                                                        <li><input type="radio" name="counseling_chk2" id="counseling_chk4" class="counselingChk counselingChk4"><label for="counseling_chk4">없음</label></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="border-bottom flex-left" colspan="8">
                                                <ul class="radio_wr">
                                                    <li><input type="radio" name="counseling_chk3" id="counseling_chk5" class="counselingChk counselingChk5"><label for="counseling_chk5">2년 미만</label></li>
                                                    <li><input type="radio" name="counseling_chk3" id="counseling_chk6" class="counselingChk counselingChk6"><label for="counseling_chk6">2~4년</label></li>
                                                    <li><input type="radio" name="counseling_chk3" id="counseling_chk7" class="counselingChk counselingChk7"><label for="counseling_chk7">5~9년</label></li>
                                                    <li><input type="radio" name="counseling_chk3" id="counseling_chk8" class="counselingChk counselingChk8"><label for="counseling_chk8">10년 이상</label></li>
                                                    <li><input type="radio" name="counseling_chk3" id="counseling_chk9" class="counselingChk counselingChk9"><label for="counseling_chk9">미구분</label></li>
                                                </ul>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="w100 border-bottom flex-left" colspan="8">
                                                <ul class="radio_wr">
                                                    <li><input type="radio" name="counseling_chk4" id="counseling_chk10" class="counselingChk counselingChk10"><label for="counseling_chk10">인터넷</label></li>
                                                    <li><input type="radio" name="counseling_chk4" id="counseling_chk11" class="counselingChk counselingChk11"><label for="counseling_chk11">홍보물</label></li>
                                                    <li><input type="radio" name="counseling_chk4" id="counseling_chk12" class="counselingChk counselingChk12"><label for="counseling_chk12">주변권유(이용자추천)</label></li>
                                                    <li><input type="radio" name="counseling_chk4" id="counseling_chk13" class="counselingChk counselingChk13"><label for="counseling_chk13">교육</label></li>
                                                    <li><input type="radio" name="counseling_chk4" id="counseling_chk14" class="counselingChk counselingChk14"><label for="counseling_chk14">기타</label></li>
                                                </ul>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="w100 border-bottom" colspan="8">
                                                <textarea name="counseling_textarea" id="counseling_textarea" class="__textarea" placeholder="고민되는 부분을 자세하게 작성해주세요."></textarea>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <div class="button_wr __mt70">
                                    <a href="<?=DIR?>/community/counseling2.php" class="cancle_btn">취소하기</a>
