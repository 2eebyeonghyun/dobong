                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="mobile_x" colspan="2">
                                                <input type="checkbox" name="checkbox1" id="checkbox1" class="checkbox"><label for="checkbox1">진로고민</label>
                                            </td>
                                            <td class="mobile_x" colspan="4">
                                                <input type="checkbox" name="checkbox2" id="checkbox2" class="checkbox"><label for="checkbox2">원아들과 관계</label>
                                            </td>
                                            <td class="mobile_x" colspan="2">
                                                <input type="checkbox" name="checkbox3" id="checkbox3" class="checkbox"><label for="checkbox3">업무관련</label>
                                            </td>
                                            
                                            <td class="mobile_checkbox border-bottom">
                                                <ul class="checkbox_wr">
                                                    <li><input type="checkbox" name="checkbox1" id="checkbox1" class="checkbox"><label for="checkbox1">진로고민</label></li>
                                                    <li><input type="checkbox" name="checkbox2" id="checkbox2" class="checkbox"><label for="checkbox2">원아들과 관계</label></li>
                                                    <li><input type="checkbox" name="checkbox3" id="checkbox3" class="checkbox"><label for="checkbox3">업무관련</label></li>
                                                    <li><input type="checkbox" name="checkbox4" id="checkbox4" class="checkbox"><label for="checkbox4">동료, 상사 관계</label></li>
                                                    <li><input type="checkbox" name="checkbox5" id="checkbox5" class="checkbox"><label for="checkbox5">영유아부모 관계</label></li>
                                                    <li><input type="checkbox" name="checkbox6" id="checkbox6" class="checkbox"><label for="checkbox6">경제적 안정</label></li>
                                                    <li><input type="checkbox" name="checkbox7" id="checkbox7" class="checkbox"><label for="checkbox7">개인사 관련</label></li>
                                                    <li><input type="checkbox" name="checkbox8" id="checkbox8" class="checkbox"><label for="checkbox8">심리, 적성, 성격검사</label></li>
                                                    <li><input type="checkbox" name="checkbox9" id="checkbox9" class="checkbox"><label for="checkbox9">아동학대예방</label></li>
                                                    <li><input type="checkbox" name="checkbox10" id="checkbox10" class="checkbox"><label for="checkbox10">기타</label></li>
                                                </ul>
                                            </td>
                                        </tr>
                                        ...
                                        <tr class="mobile_x">
                                            <td colspan="2">
                                                <input type="checkbox" name="checkbox4" id="checkbox4" class="checkbox"><label for="checkbox4">동료, 상사 관계</label>
                                            </td>
                                            <td colspan="4">
                                                <input type="checkbox" name="checkbox5" id="checkbox5" class="checkbox"><label for="checkbox5">영유아부모 관계</label>
                                            </td>
                                            <td colspan="2">
                                                <input type="checkbox" name="checkbox6" id="checkbox6" class="checkbox"><label for="checkbox6">경제적 안정</label>
                                            </td>
                                        </tr>

                                        <tr class="mobile_x">
                                            <td colspan="2">
                                                <input type="checkbox" name="checkbox7" id="checkbox7" class="checkbox"><label for="checkbox7">개인사 관련</label>
                                            </td>
                                            <td colspan="4">
                                                <input type="checkbox" name="checkbox8" id="checkbox8" class="checkbox"><label for="checkbox8">심리, 적성, 성격검사</label>
                                            </td>
                                            <td colspan="2">
                                                <input type="checkbox" name="checkbox9" id="checkbox9" class="checkbox"><label for="checkbox9">아동학대예방</label>
                                            </td>
                                        </tr>

                                        <tr class="mobile_x">
                                            <td colspan="8" class="left_text">
                                                <input type="checkbox" name="checkbox10" id="checkbox10" class="checkbox"><label for="checkbox10">기타</label>
