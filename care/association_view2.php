...
if(!$list_url) $list_url = "association_schedule2.php";
...
//		$appValue = "1";
	...
	if($ddm_result[s_cd]=="02" && (int)$attendance_result[regdate] + 86400*7 > $today_timestamp)
	{
		$appValue  = "6";
...
<?}else{?>
			...
			<dl class="__resBefore __mt20">
				...
				<dd>
					- 영상정보 처리기기(CCTV)는 방범 및 화재예방, 시설안전관리의 목적을 위해 24시간 연속 촬영 및 녹화 되고 있습니다.<br />
					- <!--본인은 영상정보 녹화에 동의합니다.-->본인은 영상정보 녹화 및 열람에 동의합니다.<br />
					- <strong>그러나 동의를 거부할 경우 공동육아방 이용에 제한을 받을 수 있습니다.</strong>
